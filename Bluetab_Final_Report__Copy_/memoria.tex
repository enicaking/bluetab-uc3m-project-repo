...
[0pt]
{}
{\contentsmargin{0pt}\thecontentslabel.\enspace\MakeUppercase{#1}}
{\contentsmargin{0pt}\MakeUppercase{#1}}
...
% ÍNDICE
% Reiniciar numeración a arábiga para el contenido
...
\begin{figure}[H]
    \centering    \includegraphics[width=0.8\textwidth]{missing_values.png}
